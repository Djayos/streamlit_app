...
def load_data():
    ...
    #remove in df2 lines that have "Adjuvant pour bouillie fongicide | Adjuvant pour bouillie insecticide  | Adjuvant pour bouillie herbicide  | Adjuvant pour bouillie de régulateur de croissance" in fonctions
    # Convert the 'fonctions' column to string type
